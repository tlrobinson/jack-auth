...
BasicRequest.prototype.decodeCredentials = function () {
    return base64.decode(this.credentials()).split(':');
}
...
BasicHandler.prototype.run = function(app) {
    ...
    return function(env) {
        ...
        if (!auth.isProvided()) return self.Unauthorized();
...
BasicHandler.prototype.challenge = function() {
...
BasicHandler.prototype.username = function() {
...
exports.BasicHandler = function(app, realm, authenticator) {
    var basic = new BasicHandler(realm, authenticator);
    return basic.run(app);
}
