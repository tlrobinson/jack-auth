...
AbstractHandler.prototype.Unauthorized = function(www_authenticate) {
    if (www_authenticate === undefined) www_authenticate = this.issueChallenge();
...
AbstractHandler.prototype.BadRequest = function() {
    return [ 400,
      { 'Content-Type': 'text/plain',
        'Content-Length' : '0'
      },
